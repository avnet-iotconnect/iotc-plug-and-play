...
4. [Modify Your Application to Send Data to and/or Receive Commands from JSON Buffer](#4-modify-your-application-to-send-data-to-andor-receive-commands-from-json-buffer)
